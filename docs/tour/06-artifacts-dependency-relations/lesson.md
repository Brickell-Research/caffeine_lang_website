...
* evaluate whether these relations are sensible and enforce hard dependency threshold constraints (i.e. it is invalid to assert a service will have 99.99% availability if it has a hard dependency on a service with just 99% availability)
